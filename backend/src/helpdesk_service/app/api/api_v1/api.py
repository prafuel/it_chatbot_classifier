...
from app.api.api_v1.endpoints.query import router as query_router
...
# Auth routes — served at /api/v1/usermanagementservice/* for frontend compatibility
router.include_router(auth_router, prefix="/usermanagementservice")
