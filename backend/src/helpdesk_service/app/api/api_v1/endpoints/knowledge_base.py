...
def create_kb_article(
    payload: schema.KnowledgeBaseCreate,
    db: Session = Depends(get_db),
    current_user: User = Depends(get_it_staff_user),
):
    """Create a new knowledge base article. (IT Staff Only)"""
...
def list_kb_articles(
    ...
    """List knowledge base articles. (IT Staff Only)"""
...
def search_kb(
    ...
    """Search approved KB articles by keyword. (IT Staff Only)"""
...
def get_kb_article(
    ...
    """Get a single KB article. (IT Staff Only)"""
...
def approve_kb_article(
    ...
    """Approve a KB article for public visibility. (IT Staff Only)"""
